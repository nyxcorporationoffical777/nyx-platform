...
import { User, Mail, Shield, TrendingUp, Calendar, Bot, CheckCircle, Star, Lock, Wallet, Copy, Users, Key, Eye, EyeOff, Zap, Gift, Clock, Upload, XCircle, PlayCircle, Info } from 'lucide-react';
